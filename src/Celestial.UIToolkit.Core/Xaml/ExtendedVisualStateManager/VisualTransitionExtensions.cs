...
namespace Celestial.UIToolkit.Xaml
{
    ...
    internal static class VisualTransitionExtensions
    {
        ...
        // We abuse attached dependency properties to "inject" properties into the VisualTransition
        // via extension methods.
        // They can only be accessed by the Get/Set extension methods.
        //
        // These properties are used by the AnimationVisualStateSwitcher to remember whether
        // a dynamically generated transition storyboard or a VisualTransition.Storyboard 
        // (-> explicit storyboard) are completed already.
        private static readonly DependencyPropertyKey _dynamicStoryboardCompletedPropertyKey = 
            DependencyProperty.RegisterAttachedReadOnly(
                "DynamicStoryboardCompleted", 
                typeof(bool), 
                typeof(VisualTransitionExtensions),
                new PropertyMetadata(true));
        
        private static readonly DependencyPropertyKey _explicitStoryboardCompletedPropertyKey = 
            DependencyProperty.RegisterAttachedReadOnly(
