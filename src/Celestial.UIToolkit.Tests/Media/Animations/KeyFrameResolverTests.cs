...
namespace Celestial.UIToolkit.Tests.Media.Animations
{
    ...
    public class KeyFrameResolverTests
    {
        ...
        public void ResolvesTimeSpanOnlyFrames()
        {
            ...
            var resolvedFrames = GetResolvedKeyFrames(
            ...
            AssertSharedKeyFrameRules(resolvedFrames);
        ...
        public void ResolvesUniformOnlyFrames()
        {
            ...
            AssertSharedKeyFrameRules(resolvedFrames);
            ValidateUniformKeyFrames(resolvedFrames);
        }
        ...
        public void ResolvesPacedOnlyFrames()
        {
            ...
            AssertSharedKeyFrameRules(resolvedFrames);
            ValidateUniformKeyFrames(resolvedFrames); // For paced only, the values should == Uniform values.
        }
        ...
        {
            var collection = BuildDoubleKeyFrameCollection(keyTimes);
        ...
        {
            AssertThatEachFrameIsResolved(frames);
            AssertThatFramesAreInOrder(frames);
        }
