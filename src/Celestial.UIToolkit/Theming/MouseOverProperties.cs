...
namespace Celestial.UIToolkit.Theming
{
    ...
    /// This class provides properties for when the user hovers a control
    /// with his mouse.
    /// </summary>
    ...
    { 
        ...
        public static readonly DependencyProperty BackgroundColorProperty = DependencyProperty.RegisterAttached(
            "BackgroundColor", typeof(Color), typeof(MouseOverProperties), new PropertyMetadata(Colors.Transparent));
        ...
        public static readonly DependencyProperty BorderColorProperty = DependencyProperty.RegisterAttached(
            "BorderColor", typeof(Color), typeof(MouseOverProperties), new PropertyMetadata(Colors.Transparent));
        ...
        public static readonly DependencyProperty ForegroundBrushProperty = DependencyProperty.RegisterAttached(
            "ForegroundBrush", typeof(Brush), typeof(MouseOverProperties), new PropertyMetadata(Brushes.Transparent));
        ...
        public static readonly DependencyProperty ShadowElevationProperty = DependencyProperty.RegisterAttached(
            "ShadowElevation", typeof(double), typeof(MouseOverProperties), new PropertyMetadata(0d));
