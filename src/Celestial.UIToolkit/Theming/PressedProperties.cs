...
namespace Celestial.UIToolkit.Theming
{
    ...
    /// This class provides properties for when the user presses a control.
    /// </summary>
    ...
    { 
        ...
        public static readonly DependencyProperty BackgroundColorProperty = DependencyProperty.RegisterAttached(
            "BackgroundColor", typeof(Color), typeof(PressedProperties), new PropertyMetadata(Colors.Transparent));
        ...
        public static readonly DependencyProperty BorderColorProperty = DependencyProperty.RegisterAttached(
            "BorderColor", typeof(Color), typeof(PressedProperties), new PropertyMetadata(Colors.Transparent));
        ...
        public static readonly DependencyProperty ForegroundBrushProperty = DependencyProperty.RegisterAttached(
            "ForegroundBrush", typeof(Brush), typeof(PressedProperties), new PropertyMetadata(Brushes.Transparent));
        ...
        public static readonly DependencyProperty ShadowElevationProperty = DependencyProperty.RegisterAttached(
            "ShadowElevation", typeof(double), typeof(PressedProperties), new PropertyMetadata(0d));
